class GalleryController < ApplicationController
        ...
        credit_card = ActiveMerchant::Billing::CreditCard.new(
           ...
           gateway =ActiveMerchant::Billing::TrustCommerceGateway.new(
            ...
            if response.success?
             ...
             flash[:notice]="Thank You. The order details are sent to your mail"
              session[:cart_id]=nil
               session[:amount]=nil
  ...
  def search
    ...
    @instruments = Store.find_by_sql ["Select * from stores WHERE name like ? or color like ? or category like ? or description like ?",keyword,keyword,keyword,keyword]
  end
end
